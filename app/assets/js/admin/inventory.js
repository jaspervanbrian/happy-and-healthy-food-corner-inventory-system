            ...
            if (stocks.length === 0) {
            	...
            	$.each(stocks, function(i, stock) {
                    ...
                    $("#type_search" + stock.id).on('change', function() {
                        if($("#reference_from_date_search" + stock.id).val() !== "" && $("#reference_to_date_search" + stock.id).val() !== "") {
                            thisMonthData = {
                                stock_id: stock.id,
                                type_search: $("#type_search" + stock.id).val(),
                                reference_keyword_search: $("#reference_keyword_search" + stock.id).val(),
                                from_date: $("#reference_from_date_search" + stock.id).val(),
                                to_date: $("#reference_to_date_search" + stock.id).val()
                            };
                        } else {
                            thisMonthData = {
                                stock_id: stock.id,
                    ...
                    $("#reference_from_date_search" + stock.id).on('change', function() {
                        if($("#reference_from_date_search" + stock.id).val() !== "" && $("#reference_to_date_search" + stock.id).val() !== "") {
                            thisMonthData = {
                                stock_id: stock.id,
                                type_search: $("#type_search" + stock.id).val(),
                    ...
                    $("#reference_to_date_search" + stock.id).on('change', function() {
                        if($("#reference_from_date_search" + stock.id).val() !== "" && $("#reference_to_date_search" + stock.id).val() !== "") {
                            thisMonthData = {
                                stock_id: stock.id,
                                type_search: $("#type_search" + stock.id).val(),
                    ...
                    function getPagination(thisMonthData) {
                        ...
                        requestForThisMonthPages.done(function(response, textStatus, jqXHR) {
                            $("#this-month-pagination"+ stock.id).empty().off();
                            if (parseInt(response) > 5) {
                                $("#this-month-pagination"+ stock.id).append('<ul class="pagination"></ul>');
                                ...
                                $("#this-month-pagination"+ stock.id).on('click', '.page-item', function() {
                                    ...
                                    console.log(thisMonthCurrentPage);
                                });
                            }
                        });
