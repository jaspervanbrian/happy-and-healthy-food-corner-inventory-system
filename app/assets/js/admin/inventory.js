                    ...
                    function getThisMonth(thisMonthData) {
                        ...
                        requestThisMonth.done(function(response, textStatus, jqXHR) {
                            ...
                            if (particulars.length === 0) {
                                ...
                                $("#particularList"+ stock.id).empty().append('<table class="table table-hover"> <thead class="thead-dark"> <th>Date</th> <th>Time</th> <th>Type</th> <th>Supplier Reference</th> <th>In</th> <th>Out</th> <th>Balance</th> <th>Amount</th> <th>Issued by</th> </thead> <tbody></tbody> </table>');
                                ...
                                $.each(particulars, function(i, particular) {
                                    ...
                                    $particularRows.append('<tr><td>' + particular.date + '</td><td>' + particular.time + '</td><td>' + particular.type + '</td><td>' + particular.supplier_reference + '</td><td>' + (particular.in > 0 ? particular.in : "") + '</td><td>' + (particular.out > 0 ? particular.out : "") + '</td><td>' + particular.balance + '</td><td>₱' + particular.price_balance + '</td><td>' + particular.issued_by + '</td></tr>');
                                });
